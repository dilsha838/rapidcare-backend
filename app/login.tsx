...
export default function Login() {
  ...
  // ── App init — auto-login check + biometric check ────────────────────────
  const initApp = async () => {
    try {
    ...
    return (
      ...
      >
        ...
        <Image
          ...
          style={{ width: width * 0.6, height: 80 }}
          resizeMode="contain"
        />
        <ActivityIndicator
          color="#3B82F6"
          ...
          style={{ marginTop: 32 }}
        />
        <Text style={{ color: "#555580", fontSize: 13, marginTop: 12 }}>
          Loading...
        </Text>
      </View>
    );
    ...
    <View style={s.root}>
      ...
      >
        ...
        >
          ...
          {/* ── Biometric card (returning users) ───────────────────────── */}
          {hasBiometric && (
            <Animated.View
              style={[
                s.bioCard,
            ...
            >
              ...
              >
                ...
                >
                  <Animated.View
                    style={[s.bioBtnInner, { transform: [{ scale: bioAnim }] }]}
                  >
                    <LinearGradient
          ...
          >
            ...
            <View style={s.cardBody}>
              <Text style={s.cardTitle}>
                {hasBiometric ? "Sign in with password" : "Welcome back"}
              </Text>
              ...
              {/* Fingerprint button (inside card too) */}
              {hasBiometric && (
                <TouchableOpacity
...
const s = StyleSheet.create({
  ...
  bioBtnLabel: { fontSize: 10, color: "#3B82F6", fontWeight: "600" },
